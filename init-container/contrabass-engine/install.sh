...
tar -zxf containerd-1.7.5-linux-amd64.tar.gz -C /usr/local/ && \
...
nerdctl run -dt --name okestro-os-ansible2 --ulimit nofile=65536:65536 -v ./okestro:/root/okestro -v $(pwd)/../cao:/root/okestro/okestro-openstack/roles/contrabass/files/cao openstack-ansible:$image_version
