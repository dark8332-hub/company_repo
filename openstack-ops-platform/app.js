...
const inspectionGroups = [
  ...
  {title:'로그 점검', description:'주요 서비스와 시스템 로그의 오류 탐색', items:[
    ...
    ['System','Glance log','/var/log/glance/*.log에서 ERROR 확인','glance_log'], ['System','Manila log','/var/log/manila/*.log에서 ERROR 확인','manila_log'], ['System','Octavia log','/var/log/octavia/*.log에서 ERROR 확인','octavia_log'], ['System','System log','syslog/messages에서 ERROR 확인','system_log']
  ]},
